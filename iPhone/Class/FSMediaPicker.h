...
@optional
- (void)mediaPicker:(FSMediaPicker *)mediaPicker willPresentImagePickerController:(LCImagePickerViewController *)imagePicker;
...
@property (copy, nonatomic) void(^willPresentImagePickerBlock)(FSMediaPicker *mediaPicker, LCImagePickerViewController *imagePicker);

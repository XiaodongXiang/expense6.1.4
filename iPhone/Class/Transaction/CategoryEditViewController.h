...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *subcategoryLineHigh;
...
@property(nonatomic,strong)SettingPayeeEditViewController   *payeeEditViewController;
-(void)refleshUI;
@end

...
@protocol KalDataSourceCallbacks_bill_iPhone;

@protocol KalDataSource_bill_iPhone <NSObject, UITableViewDataSource,UITableViewDelegate>
...
@protocol KalDataSourceCallbacks_bill_iPhone <NSObject>
- (void)loadedDataSource:(id<KalDataSource_bill_iPhone>)dataSource;
 @end
...
@interface SimpleKalDataSource_bill_iPhone : NSObject <KalDataSource_bill_iPhone>
{
}

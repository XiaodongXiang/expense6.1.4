...
-(void)initNavStyle{
    ...
    self.navigationItem.title =  billFather.bf_billName;
    ...
    [customerButton1 setTitleColor:[UIColor colorWithRed:99/255.0 green:206/255.0 blue:255/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    self.navigationItem.leftBarButtonItems = @[flexible,leftButton];
 	...
 	UIButton *payBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 60, 30)];
	[payBtn setTitle:NSLocalizedString(@"VC_Pay", nil) forState:UIControlStateNormal];
    [payBtn.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:17]];
    [payBtn setTitleColor:[UIColor colorWithRed:99/255.0 green:206/255.0 blue:255/255.0 alpha:1] forState:UIControlStateNormal];
    PokcetExpenseAppDelegate *appDelegate = (PokcetExpenseAppDelegate *)[[UIApplication sharedApplication]delegate];

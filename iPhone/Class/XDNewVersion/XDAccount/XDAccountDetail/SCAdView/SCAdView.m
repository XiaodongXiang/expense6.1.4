...
-(void)setUpWithBuilder:(SCAdViewBuilder *)builder{
    ...
    [self.collectionView scrollToItemAtIndexPath:[NSIndexPath indexPathForRow:builder.index inSection:0] atScrollPosition:UICollectionViewScrollPositionCenteredHorizontally animated:YES];

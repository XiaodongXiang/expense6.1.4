//http://code.google.com/p/iphone-elite/source/browse/trunk/ZiPhone/?r=606
/*
...
void md5_finish( md5_context *ctx, unsigned char output[16] )
{
    ...
    md5_update( ctx, (unsigned char *) md5_padding, (int)padn );
...
int md5_self_test( int verbose )
{
    ...
    for( i = 0; i < 7; i++ )
    {
        ...
        md5( (unsigned char *) md5_test_str[i],
			(int)strlen( md5_test_str[i] ), md5sum );

...
@interface KalViewController : UIViewController <KalViewDelegate, KalDataSourceCallbacks,UIPopoverControllerDelegate>
{
  KalLogic *logic;
...
@property (nonatomic,assign)  BOOL   isHidenHeaderView;

...
@implementation ipad_CategorySplitCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
		...
		categoryNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(46.0, 0.0, 200.0, 44.0)];
        ...
        amountTextField = [[UITextField alloc]initWithFrame:CGRectMake(270, 0, 255, 43)];
        [amountTextField setFont:[UIFont fontWithName:@"HelveticaNeue" size:17.0]];
		[amountTextField setTextColor:[UIColor colorWithRed:94.0/255 green:94.0/255 blue:94.0/255 alpha:1]];
...
-(void)layoutSubviews{
    ...
    {
        categoryIconImage.frame = CGRectMake(9, 8.0, 28.0, 28.0);
        categoryNameLabel.frame = CGRectMake(46.0, 0.0, 200.0, 44.0);
    }

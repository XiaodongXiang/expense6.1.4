...
-(void)awakeFromNib
{
	...
	clippingView = [[UIView alloc] initWithFrame:CGRectMake(0,2,91,27)];
...
//	}
	...
	NSString *leftLabelText = @"YES";
 	leftLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 2, 51, 27)];
	[leftLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Bold" size:16.0]];
	...
	NSString *rightLabelText =@"NO";
   	rightLabel = [[UILabel alloc] initWithFrame:CGRectMake(91, 0, 51,27)];
	[rightLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Bold" size:16.0]];
...
-(void)layoutSubviews
{
	...
	self.leftLabel.frame = CGRectMake(xPos, 2, labelWidth, 27);
	...
	self.rightLabel.frame = CGRectMake(xPos, 2, labelWidth, 27);
...
{	
    ...
    if (tint != nil) 
	{
		...
		CGContextClipToMask(currentContext, CGRectMake(0, 0, 41, image.size.height), maskImage);
		CGContextDrawImage(currentContext, CGRectMake(0,0, 41, image.size.height), image.CGImage);

		[image drawAtPoint:CGPointMake(0,0)];
		[tint setFill];
		//UIRectFillUsingBlendMode(CGRectMake(0,0,image.size.width,image.size.height),kCGBlendModeColor);
		UIRectFillUsingBlendMode(CGRectMake(0,0,41,image.size.height),kCGBlendModeColor);
